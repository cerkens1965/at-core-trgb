...
static void mkTestOverlay(){
    ...
    // Sound test — rejoue le carillon audio à la demande (I2S DAC ; no-op hors WS-241)
    mkTB("Sound test",             y+5*DY,lv_color_hex(0x7c3aed), [](lv_event_t*e){ if(lv_event_get_code(e)==LV_EVENT_CLICKED) audioTestChime(); });
}
