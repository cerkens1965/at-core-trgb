...
void acEditShow(){
    ...
    lv_obj_set_size(g_acedit_ov,SCR_W,SCR_H); lv_obj_set_pos(g_acedit_ov,UI_OX,UI_OY);   // board-aware
    ...
    lv_obj_set_size(g_acedit_ta,SCR_W-40,46); lv_obj_set_pos(g_acedit_ta,20,42);
